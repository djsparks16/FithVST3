...
namespace
{
    ...
    void drawCard(Graphics& g, Rectangle<float> r, const String& title)
    {
        ...
        auto titleArea = Rectangle<int>(roundToInt(r.getX() + 10.0f),
                                        roundToInt(r.getY() + 6.0f),
                                        roundToInt(r.getWidth() - 20.0f),
                                        20);
        g.drawText(title, titleArea, Justification::left, false);
    }
